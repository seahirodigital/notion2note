...
1. エグゼクティブ・サマリー本文のみ。`A: エグゼクティブ・サマリー` のH2見出しは出さず、結論の箇条書きから始めます。
2. Notion本文画像。Notion画像ブロックの1枚目はサムネイル用に使い、2枚目以降を本文へ連続添付します。
3. YouTubeリンク
4. アフィリエイトリンク1つめ
5. 目次
6. Disclaimer
7. H2: インサイトまとめ。本文もこの見出し直下に配置します。
8. アフィリエイトリンク2つめ
9. H2: 詳細情報
10. アフィリエイトリンク3つめ
11. YouTubeリンク
...
- Notionプロパティ内のYouTube URLを検出し、本文画像の直後と記事末尾へ配置します。
- Amazonアソシエイト表記をテンプレート内の3つのスロットへ配置します。
- H2 `文字起こし` または `transcript` 以降の本文を除外します。
- Notion画像ブロックを収集します。
- 画像は1枚目をnoteトップ画像、2枚目以降をエグゼクティブ・サマリー本文の直後へまとめて配置します。
- Notionカバー画像、または最初のNotion画像をnoteトップ画像に使います。
- `affiliate_links.txt` の指定MEMOから、テンプレート順にアフィリエイト文面を挿入します。
